	...
	namespace SSEElementsTests{
		...
		public class SSEStatesTests : SlotSystemTest{
			...
			public void VariousStates_EnterState_prevNull_CallsInstantMethods(IUISelStateHandler selStateHandler, UIState state){
				...
				if(state is UIFocusedState)
					selStateHandler.Received().InstantFocus();
				else if(state is UIDefocusedState)
				...
				class VariousStates_EnterStateCases: IEnumerable{
					public IEnumerator GetEnumerator(){
						TestCaseData case_0;
							...
							IUISelState focusedState_0 = new UIFocusedState(selStateHandler_0);
						...
						TestCaseData case_1;
							...
							IUISelState focusedState_1 = new UIDefocusedState(selStateHandler_1);
				...
				class Various_EnterState_FromVariousNonNullCases: IEnumerable{
					...
					public IEnumerator GetEnumerator(){
							...
							TestCaseData dea_foc_foc;
									...
									IUISelState foc_5 = new UIFocusedState(selStateHandler_5);
							...
							TestCaseData foc_foc_foc;
									...
									IUISelState foc_6 = new UIFocusedState(selStateHandler_6);
							...
							TestCaseData def_foc_foc;
									...
									IUISelState foc_7 = new UIFocusedState(selStateHandler_7);
							...
							TestCaseData sel_foc_foc;
									...
									IUISelState foc_8 = new UIFocusedState(selStateHandler_8);
							...
							TestCaseData dea_def_def;
									...
									IUISelState def_9 = new UIDefocusedState(selStateHandler_9);
							...
							TestCaseData foc_def_def;
									...
									IUISelState def_10 = new UIDefocusedState(selStateHandler_10);
							...
							TestCaseData def_def_def;
									...
									IUISelState def_11 = new UIDefocusedState(selStateHandler_11);
							...
							TestCaseData sel_def_def;
									...
									IUISelState def_12 = new UIDefocusedState(selStateHandler_12);
