...
namespace UISystem{
	public class SBEqpStateHandler : ISBEqpStateHandler {
		...
		/* States */
			IUIStateEngine<ISBEqpState> eqpStateEngine{
				get{
					if(m_eqpStateEngine == null)
						m_eqpStateEngine = new UIStateEngine<ISBEqpState>();
					return m_eqpStateEngine;
				}
			}
				IUIStateEngine<ISBEqpState> m_eqpStateEngine;
		...
		/*	Equip Process	*/
			...
			IUIProcessEngine<ISBEqpProcess> eqpProcEngine{
				get{
					if(m_eqpProcEngine == null)
						m_eqpProcEngine = new UIProcessEngine<ISBEqpProcess>();
					return m_eqpProcEngine;
				}
			}
				IUIProcessEngine<ISBEqpProcess> m_eqpProcEngine;
			public void SetEqpProcessEngine(IUIProcessEngine<ISBEqpProcess> engine){
