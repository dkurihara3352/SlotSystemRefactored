            ...
            public class EquipInventoryTests: SlotSystemTest{
                /*  Add */
                    ...
                    public void Add_BowInst_EquipsBow(IEnumerable<BowInstance> added){
                        EquippedItemsInventory equipInv = new EquippedItemsInventory(MakeBowInstance(0), MakeWearInstance(0), new List<CarriedGearInstance>(), 0);
                    ...
                    public void Add_CGearsExceedingLimit_ThrowsException(List<CarriedGearInstance> fitted, CarriedGearInstance exceeded){
                        EquippedItemsInventory equipInv = new EquippedItemsInventory(MakeBowInstance(0), MakeWearInstance(0), new List<CarriedGearInstance>(), fitted.Count);
