			...
			public void SetTACacheRecursively_Always_SetsIHoverableTACache(){
				SlotSystemManager ssm = MakeSSM();
					...
					pBun.transform.SetParent(ssm.transform);
						SlotGroup sgpA = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
						...
						SlotGroup sgpB = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
					...
					eBun.transform.SetParent(ssm.transform);
						...
						eSetA.transform.SetParent(eBun.transform);
							...
							SlotGroup sgeBow = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
								sgeBow.transform.SetParent(eSetA.transform);
								sgeBow.InspectorSetUp(eInv, new SGBowFilter(), new SGItemIDSorter(), 1);
							SlotGroup sgeWear = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
								sgeWear.transform.SetParent(eSetA.transform);
								sgeWear.InspectorSetUp(eInv, new SGWearFilter(), new SGItemIDSorter(), 1);
							SlotGroup sgeCGears = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
					...
					gBunA.transform.SetParent(ssm.transform);
						...
						ssegA.transform.SetParent(gBunA.transform);
							SlotGroup sggAA = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
							sggAA.transform.SetParent(ssegA.transform);
							SlotGroup sggAB = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
							sggAB.transform.SetParent(ssegA.transform);
						ssegA.SetHierarchy();
						SlotSystemBundle gBunAA = MakeSSBundle();
						gBunAA.transform.SetParent(gBunA.transform);
							SlotGroup sggAAA = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
							sggAAA.transform.SetParent(gBunAA.transform);
							SlotGroup sggAAB = MakeSGWithSubs_RSBHandler_RCommands_RSlotsHolder_RFilterHandler();
