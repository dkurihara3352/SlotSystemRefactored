...
namespace SlotSystemTests{
	namespace SGTests{
		...
		public class SGFilterTests: SlotSystemTest {
			...
			public void SGFilter_Filter_WhenCalled_SetsItemsAccordingly(SGFilter targFilter, List<IInventoryItemInstance> targList, IEnumerable<IInventoryItemInstance> expected){
				SGFilter filter = targFilter;
                List<IInventoryItemInstance> list = targList;
				...
				class SGFilterCases: IEnumerable{
					public IEnumerator GetEnumerator(){
						object[] bowFilter;
							...
							MeleeWeaponInstance mWeaponA1_1 = MakeMWeaponInstance(0);
							MeleeWeaponInstance mWeaponA2_1 = MakeMWeaponInstance(0);
							...
							List<IInventoryItemInstance> list_1 = new List<IInventoryItemInstance>(new IInventoryItemInstance[]{
							...
							IEnumerable<IInventoryItemInstance> expected_1 = new IInventoryItemInstance[]{
								bowA0_1, bowA1_1, bowA2_1
							};
						...
						object[] wearFilter;
							...
							MeleeWeaponInstance mWeaponA1_2 = MakeMWeaponInstance(0);
							MeleeWeaponInstance mWeaponA2_2 = MakeMWeaponInstance(0);
							...
							List<IInventoryItemInstance> list_2 = new List<IInventoryItemInstance>(new IInventoryItemInstance[]{
							...
							IEnumerable<IInventoryItemInstance> expected_2 = new IInventoryItemInstance[]{
								wearA0_2, wearA1_2, wearA2_2
							};
						...
						object[] cGearsFilter;
							...
							MeleeWeaponInstance mWeaponA0_3 = MakeMWeaponInstance(0);
							MeleeWeaponInstance mWeaponA1_3 = MakeMWeaponInstance(0);
							MeleeWeaponInstance mWeaponA2_3 = MakeMWeaponInstance(0);
							...
							List<IInventoryItemInstance> list_3 = new List<IInventoryItemInstance>(new IInventoryItemInstance[]{
							...
							IEnumerable<IInventoryItemInstance> expected_3 = new IInventoryItemInstance[]{
								shieldA0_3, shieldA1_3, shieldA2_3,
								mWeaponA0_3, mWeaponA1_3, mWeaponA2_3,
								quiverA0_3, quiverA1_3, quiverA2_3,
								packA0_3, packA1_3, packA2_3
						...
						object[] partsFilter;
							...
							MeleeWeaponInstance mWeaponA0_4 = MakeMWeaponInstance(0);
							MeleeWeaponInstance mWeaponA1_4 = MakeMWeaponInstance(0);
							MeleeWeaponInstance mWeaponA2_4 = MakeMWeaponInstance(0);
							...
							List<IInventoryItemInstance> list_4 = new List<IInventoryItemInstance>(new IInventoryItemInstance[]{
							...
							IEnumerable<IInventoryItemInstance> expected_4 = new IInventoryItemInstance[]{
								partsA0_4, partsA1_4, partsA2_4
							};
