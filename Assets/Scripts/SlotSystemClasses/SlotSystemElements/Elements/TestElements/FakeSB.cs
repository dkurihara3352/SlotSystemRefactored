...
public class FakeSB : Slottable {
	...
	public void SetPrevSelState(SSEState state){
		m_prevSelState = state;
	}
	...
	public override SSEState prevSelState{
		get{
			return m_prevSelState;
		}
	}SSEState m_prevSelState;
	public void SetPrevActState(SSEState state){
		m_prevActState = state;
	}
	...
	public override void SetSSMActState(SSMActState ssmState){
		m_ssmActStateSet = ssmState;
	}
		public SSMActState SSMActStateSet{
			get{return m_ssmActStateSet;}
		}
	...
	public void SetIsFocused(bool toggle){
		m_isFocused = toggle;
	}
	...
	public void SetIsPickedUp(bool on){
		m_isPickedUp = on;
	}
	...
	public override bool isStackable{get{return m_isStackable;}}
		bool m_isStackable;
		public void SetIsStackable(bool on){
			m_isStackable = on;
		}
}
